...
export const Markdown = memo(function Markdown({
  ...
  // shikiTheme enables code syntax highlighting (Streamdown handles Shiki internally)
  // mermaid prop enables diagram rendering when enableMermaid is true
  const mermaidProp = enableMermaid ? {} : undefined;

  return (
    <Streamdown
      className={cn("text-foreground leading-relaxed", className)}
      components={{ ...components, ...customComponents }}
      shikiTheme={enableCode ? shikiTheme : undefined}
      mermaid={mermaidProp}
      controls={controls}
      {...props}
    >
